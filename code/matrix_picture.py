...
# 读取 .npy 矩阵文件
matrix_1 = np.load(os.path.join(os.path.dirname(__file__), 'result','随机矩阵法结果', 'rabdom_matrix_ground_state.npy'))
matrix_2 = np.load(os.path.join(os.path.dirname(__file__), 'result','随机矩阵法结果', 'rabdom_matrix_mixed.npy'))
matrix_3 = np.load(os.path.join(os.path.dirname(__file__), 'result','随机矩阵法结果', 'matrix_inversion_complex_state.npy'))
